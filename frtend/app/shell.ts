...
type StaticNonFireRoutePath = Exclude<
  StaticRoutePath,
  typeof ROUTES.fire | typeof ROUTES.carvingsArticles
>;
type AppRoute = Exclude<
  StaticRoutePath,
  typeof ROUTES.unburntMine | typeof ROUTES.unburntNew
>;
type FirePunchline = {
  en: string;
  zh: string;
...
function renderRouteAppendix(route: StaticNonFireRoutePath): string {
  ...
  const articlesHref = buildLocalizedPath("/carvings/articles", currentLocale);
  ...
  return `
    <section class="carvings-articles-entry">
      <a
        ...
        href="${escapeAttribute(articlesHref)}"
